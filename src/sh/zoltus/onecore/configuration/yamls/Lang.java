...
public enum Lang implements IConfig {
    ...
    DELHOME_DELETED("delhome.deleted"),
    DELHOME_OTHER("delhome.other"),
    SETHOME_OTHER("sethome.other"),
    ...
    SETHOME_FULL_HOMES("sethome.full-homes"),
    ...
    TP_OFFLINE_TARGET("tp.offline-target"),
    TP_OFFLINE_TARGETS("tp.offline-targets"),
