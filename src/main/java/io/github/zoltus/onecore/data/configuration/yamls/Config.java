...
public enum Config implements IConfig {
    ...
    BROADCAST_SOUND_ENABLED("broadcast.sound-enabled"),
    BROADCAST_SOUND("broadcast.sound"),
    BROADCAST_SOUND_VOLUME("broadcast.sound-volume"),
    BROADCAST_SOUND_PITCH("broadcast.sound-pitch"),
    ...
    MENTION_SOUND_ENABLED("mentions.sound-enabled"),
    MENTION_SOUND("mentions.sound"),
    MENTION_SOUND_VOLUME("mentions.sound-volume"),
    MENTION_SOUND_PITCH("mentions.sound-pitch"),
