...
public enum Config implements IConfig {
    ...
    DB_ADDRESS("database.data.address"),
    DB_PORT("database.data.port"),
    DB_DATABASE("database.data.database"),
    DB_USERNAME("database.data.username"),
    DB_PASSWORD("database.data.password"),
