...
public enum Commands implements IConfig {
    ...
    BACK_PERMISSION_OTHER("back.permission-other"),
    ...
    ENDER_CHEST_PERMISSION_OTHER("enderchest.permission-other"),
    ...
    GAMEMODE_PERMISSION_OTHER("gamemode.permission-other"),
    ...
    PING_PERMISSION_OTHER("ping.permission-other"),
    ...
    PLAYTIME_PERMISSION_OTHER("playtime.permission-other"),
    ...
    REPAIR_PERMISSION_OTHER("repair.permission-other"),
    ...
    SETHOME_PERMISSION_OTHER("sethome.permission-other"),
    ...
    TOP_LABEL("top.label"),
    TOP_PERMISSION_OTHER("top.permission-other"),
