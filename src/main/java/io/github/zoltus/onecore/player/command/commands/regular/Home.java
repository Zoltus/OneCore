    ...
    public void init() {
        ...
        Argument<?> homeArg0 = new HomeArg0() //String
                .executesPlayer((p, args) -> {
                    ...
                    String home = args.getOrDefault(0, (String) Commands.HOME_DEFAULT_NAME.get()).toString();
        ...
        Argument<?> homeArg1 = new HomeArg1() //
                ...
                .executes((sender, args) -> {
                    ...
                    String home = args.getOrDefault(1, (String) Commands.HOME_DEFAULT_NAME.get()).toString();
